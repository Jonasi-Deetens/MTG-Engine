...
from axis3.compiler.ability_builder import register_runtime_abilities_for_object
from axis3.compiler.continuous_builder import build_continuous_effects_for_object
from axis3.compiler.replacement_builder import build_replacement_effects_for_object
