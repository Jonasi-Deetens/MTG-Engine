...
class GameState:
    ...
    def __post_init__(self):
        ...
        # Runtime executors (Axis2 → game actions)
        from axis3.runtime.subject_resolver import SubjectResolver
        from axis3.runtime.effect_executor import EffectExecutor
        from axis3.runtime.cost_executor import CostExecutor

        self.subject_resolver = SubjectResolver(self)
        self.effect_executor = EffectExecutor(self)
        self.cost_executor = CostExecutor(self)
        self.continuous_effects: List[Any] = getattr(self, "continuous_effects", [])
    ...
    @property
    def players_by_id(self) -> Dict[int, PlayerState]:
