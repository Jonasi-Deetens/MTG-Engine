...
from axis3.engine.triggers.registry import check_triggers
from axis3.engine.stack.resolver import resolve_top_of_stack
...
class GameOrchestrator:
    ...
    def push_to_stack(self, stack_item: StackItem):
        self.game_state.stack.push(stack_item)
