...
def _register_all_parsers():
    ...
    """
    from . import delayed, zone_change, dies, enter_tapped, damage, draw, mana_replacement, counter_modification, destruction, as_enters_choice
    ...
    register_parser(as_enters_choice.AsEntersChoiceParser())  # priority 48
    register_parser(destruction.DestructionParser())   # priority 46
