...
export function PlayProviders({ children }: { children: React.ReactNode }) {
  ...
  const targetingValue = useMemo<PlayTargetingContextValue>(() => ({
    ...
    hasPendingSearchChoices: state.hasPendingSearchChoices,
    ...
    copyTargetsCount: state.copyTargetsCount,
    ...
    state.searchTargetsByEffect, state.searchErrors, state.hasPendingSearchChoices, state.copySpellConfig, state.copyTargetSelections,
    state.copyTargetErrorsGlobal, state.copyTargetsCount, state.copyTargetsByEffectCount, state.copyEffectTargetGroups,
