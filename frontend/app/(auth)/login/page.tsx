      ...
      <div className="w-full max-w-md">
        <Card variant="elevated" className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {success && (
              <div className="p-3 bg-[color:var(--theme-status-success)]/20 border border-[color:var(--theme-status-success)]/50 rounded-lg text-[color:var(--theme-status-success)] text-sm">
                {success}
              </div>
            )}
            {error && (
          ...
          <div className="mt-6 text-center text-sm text-[color:var(--theme-text-secondary)]">
            <p>
              ...
              <Link href="/register" className="text-[color:var(--theme-accent-primary)] hover:text-[color:var(--theme-accent-hover)] underline">
                Register here
              </Link>
            </p>
          </div>
