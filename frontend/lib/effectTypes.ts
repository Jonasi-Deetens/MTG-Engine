...
export function getEffectTypeOption(type: string): EffectTypeOption | undefined {
  return EFFECT_TYPE_OPTIONS.find((opt) => opt.value === type);
}
...
export const TARGET_OPTIONS = [
  ...
  { value: 'creatures_opponents_control', label: 'Creatures Opponents Control' },
  { value: 'target_creature_you_control', label: 'Target Creature You Control' },
  { value: 'target_creature_opponents_control', label: 'Target Creature Opponent Controls' },
  { value: 'permanents_you_control', label: 'Permanents You Control' },
  { value: 'permanents_opponents_control', label: 'Permanents Opponents Control' },
  { value: 'target_permanent_you_control', label: 'Target Permanent You Control' },
  { value: 'target_permanent_opponents_control', label: 'Target Permanent Opponent Controls' },
  { value: 'artifacts_you_control', label: 'Artifacts You Control' },
  { value: 'artifacts_opponents_control', label: 'Artifacts Opponents Control' },
  { value: 'target_artifact_you_control', label: 'Target Artifact You Control' },
  { value: 'target_artifact_opponents_control', label: 'Target Artifact Opponent Controls' },
  { value: 'enchantments_you_control', label: 'Enchantments You Control' },
  { value: 'enchantments_opponents_control', label: 'Enchantments Opponents Control' },
  { value: 'target_enchantment_you_control', label: 'Target Enchantment You Control' },
  { value: 'target_enchantment_opponents_control', label: 'Target Enchantment Opponent Controls' },
  { value: 'planeswalkers_you_control', label: 'Planeswalkers You Control' },
  { value: 'planeswalkers_opponents_control', label: 'Planeswalkers Opponents Control' },
  { value: 'target_planeswalker_you_control', label: 'Target Planeswalker You Control' },
  { value: 'target_planeswalker_opponents_control', label: 'Target Planeswalker Opponent Controls' },
  { value: 'lands_you_control', label: 'Lands You Control' },
  { value: 'lands_opponents_control', label: 'Lands Opponents Control' },
  { value: 'target_land_you_control', label: 'Target Land You Control' },
  { value: 'target_land_opponents_control', label: 'Target Land Opponent Controls' },
