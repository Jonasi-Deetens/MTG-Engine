    ...
    <div className="w-full max-w-3xl mx-auto px-4">
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-14 pr-12 py-4 bg-white/95 backdrop-blur-sm text-slate-900 text-lg rounded-lg border-2 border-amber-500/50 focus:border-amber-500 focus:outline-none shadow-xl"
          autoFocus
        />
        {searchQuery && (
          <button
            onClick={() => onSearchChange('')}
            className="absolute right-4 top-1/2 transform -translate-y-1/2 p-1 hover:bg-slate-200 rounded transition-colors"
