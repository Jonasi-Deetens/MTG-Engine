...
export function AbilityList({ type, onAdd, onEdit }: AbilityListProps) {
  ...
  switch (type) {
    ...
    case 'activated':
      ...
      break;
    case 'spell':
      abilities = store.spellAbilities;
      removeFunction = store.removeSpellAbility;
      break;
    case 'static':
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Button
          ...
          size="sm"
        >
          + Add {type === 'continuous' ? 'Continuous' : type === 'spell' ? 'Spell' : type.charAt(0).toUpperCase() + type.slice(1)}
        </Button>
      </div>
